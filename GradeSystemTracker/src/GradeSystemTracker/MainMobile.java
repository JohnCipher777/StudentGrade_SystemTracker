...
public class MainMobile {
    ...
    private static void printMenu() {
        ...
        System.out.println( Color+"  _____            __    __  ___         __                 "+resetColor);
        System.out.println( Color+" / ___/______ ____/ /__ /  |/  /__ ____ / /____ ____        "+resetColor);
        System.out.println( Color+"/ (_ / __/ _ `/ _  / -_) /|_/ / _ `(_-</ __/ -_) __/        "+resetColor);
        System.out.println( Color+"\\___/_/  \\_,_/\\_,_/\\__/_/  /_/\\_,_/___/\\__/\\__/_/    "+resetColor);
                
        Color = "\u001B[92m";//light green
        System.out.println(Color+"                    v1.0(beta)           "+ resetColor);
        Color = "\u001B[31m";//red
        ...
        System.out.println(Color+"Exit                     "+resetColor);
         Color = "\u001B[31m";//red
        System.out.println(Color + " ______________________________________________" + resetColor );
        System.out.println(Color + " ==============================================" + resetColor );
        Color = "\u001B[36m";//cyan
